...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ParallelLinksExample_js__ = __webpack_require__(172);
...
var instance = new __WEBPACK_IMPORTED_MODULE_0__ParallelLinksExample_js__["a" /* default */]('example1');
...
/* harmony export (immutable) */ __webpack_exports__["a"] = ParallelLinksExample;
...
(function (global, factory) {
    ...
    function initLinks(links) {
        var LINK_WIDTH = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2;
    ...
    function transform(d) {
        var calcTranslation = isMethodExact() ? calcTranslationExact : calcTranslationApproximate;
        var translation = calcTranslation(d.targetDistance, d.source, d.target);
        return "translate (" + translation.dx + ", " + translation.dy + ")";
    }

    exports.parallelLinksSetMethodExact = setMethodExact;
    exports.parallelLinksSetMethodApprox = setMethodApprox;
    exports.parallelLinksIsMethodExact = isMethodExact;
    exports.parallelLinksInitLinks = initLinks;
    exports.parallelLinksTransform = transform;
...
var update = __webpack_require__(468)(content, options);
...
exports = module.exports = __webpack_require__(467)(undefined);
// imports
